namespace :deploy do
  task :setup_config do
    on roles(:app) do
      # make the config dir
      execute :mkdir, "-p /home/deployer/apps/dss-wayfinding/config"
      ...
      executable_files.each do |file|
        execute :chmod, "+x /home/deployer/apps/dss-wayfinding/config/#{file}"
      end
      ...
      symlinks.each do |symlink|
        sudo "ln -nfs /home/deployer/apps/dss-wayfinding/config/#{symlink[:source]} #{sub_strings(symlink[:link])}"
      end
    end
  end
end
